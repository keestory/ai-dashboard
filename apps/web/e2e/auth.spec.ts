...
test.describe('Authentication', () => {
  test.describe('Login Page', () => {
    ...
    test('should show error for invalid credentials', async ({ page }) => {
      ...
      await page.getByPlaceholder('email@example.com').fill('invalid@test.com');

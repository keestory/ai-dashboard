    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8 xl:px-12">
        <div className="w-full max-w-sm mx-auto">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-1">무료로 시작하기</h1>
        ...
        <div className="relative h-full flex flex-col items-center justify-center p-12">
          <div className="max-w-md">
            ...
            <p className="text-blue-200 mb-10">
              팀원에겐 실행 액션, 팀장에겐 전략, 임원에겐 의사결정 포인트를 전달합니다.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 bg-white/10 backdrop-blur rounded-xl px-4 py-3">
                ...
                <div>
                  <p className="text-white font-medium text-sm">팀원</p>
                  <p className="text-blue-300 text-xs">바로 실행 가능한 To-Do 리스트</p>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white/10 backdrop-blur rounded-xl px-4 py-3">
                ...
                <div>
                  <p className="text-white font-medium text-sm">팀장</p>
                  <p className="text-violet-300 text-xs">전략 방향 + 리소스 배분 가이드</p>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white/10 backdrop-blur rounded-xl px-4 py-3">
                <div className="w-8 h-8 bg-gray-500/30 rounded-lg flex items-center justify-center flex-shrink-0">
                  <LayoutDashboard className="h-4 w-4 text-gray-300" />
                </div>
                <div>
                  <p className="text-white font-medium text-sm">임원</p>
                  <p className="text-gray-300 text-xs">의사결정 포인트 + 숫자 근거</p>
                </div>
              </div>
            </div>

            <p className="mt-8 text-sm text-blue-300/70">
              월 3회 무료 분석 &middot; 가입 30초
            </p>
          </div>
        </div>
      </div>
